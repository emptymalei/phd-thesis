...
In the two-beam line model, neutrinos or antineutrinos are emitted in two different directions from a line which preserves the translation symmetry on this line. The emission angles are defined in Fig.~\ref{chap:collective-sec:two-beams-fig:two-beam-line-model}. For convenience of notations, I define a number density distribution function
\begin{equation}
