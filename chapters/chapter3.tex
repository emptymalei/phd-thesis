...
In Sec.~\ref{chap:matter-sec:single}, I have discussed the scenario where the $n=1$ Rabi mode is on or close to resonance and $\lambda_1/\omega_\mm \ll 1$. Using the asymptotic form of the Bessel function
\begin{equation}
