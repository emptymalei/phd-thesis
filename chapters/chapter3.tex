...
%I need a better frame to understand the evolution of the state vector $\vec s$.
...
\section{\label{chap:matter-sec:single-revisted}Single-Frequency Matter Profiles Revisited}
