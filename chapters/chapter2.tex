...
Every two-by-two Hermitian matrix can be expanded in the quaternian basis. For example, the Hamiltonian for neutrino oscillations in vacuum (in flavor basis) can be written as
\begin{equation}
